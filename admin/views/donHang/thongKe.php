...
<div style="width: 1050px; margin:0px auto;" class="card-body">
    ...
    <div class="form-group col-md-12   " style="padding:20px 0px;">
            ...
            foreach ($listDonHang as $key => $value) {
                ...
                if ($value['trang_thai_id'] == 2) {
                    $tongDonDaXacNhan += 1;
                }
                if ($value['trang_thai_id'] == 1) {
                    $tongDonChuaXacNhan += 1;
                }
            ...
            <table class="table table-striped table-border">
                <thead>
                    <tr>
                        ...
                        <th scope="col">Tổng đơn đã xác nhận</th>
                        <th scope="col">Tổng đơn chưa xác nhận</th>
                        <th scope="col">Tổng đơn đã giao</th>
                        <th scope="col">Tổng đơn đã hủy</th>
                        <th scope="col">Tổng đơn đang giao</th>
                        <th scope="col">Tổng đơn đã hoàn hàng</th>
                    </tr>
                </thead>
                <tbody>
                    ...
                    <tr>
                        <td><?= $tongDonHang ?></td>
                        <td><?= $tongDonDaXacNhan ?></td>
                        <td><?= $tongDonChuaXacNhan ?></td>
